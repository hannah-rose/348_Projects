...
# ***************************************************************
    ...
    # Testing function is after end of HMM class
...
# Function to test the Viterbi algorithm
def test_viterbi():
        ''' Creates a set of simple prior probabilities, a transition model
            and an evidence model to test the Viterbi algorithm '''
